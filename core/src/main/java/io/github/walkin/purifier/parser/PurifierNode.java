...
import io.github.walkin.purifier.name.AnyShallowName;
import io.github.walkin.purifier.name.SquigglyName;
 ...
 */
@ThreadSafe
public class PurifierNode {

    private final SquigglyName name;

    private final List<PurifierNode> children;
     ...
     * @see #isSquiggly()
     */
    public PurifierNode(SquigglyName name, List<PurifierNode> children, boolean negated, boolean squiggly,
                        boolean emptyNested) {
        this.name = name;
     ...
     * @return child nodes
     */
    public List<PurifierNode> getChildren() {
        return children;
    }
